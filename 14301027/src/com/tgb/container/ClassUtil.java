...
public class ClassUtil {
    ...
    private static Set<Class<?>> CLASS_Autowired_SET;
    //private static final Logger LOGGER = LoggerFactory.getLogger(ClassUtil.class);
	public static void main(String[] args) {
		Set<Class<?>> classSet = new HashSet<Class<?>>();
		classSet=getBeanClassSet("test1");
		for (Iterator<Class<?>> it = classSet.iterator();it.hasNext();)
		System.out.println(it.next().getName());
	}
	
	 /**
     * 获取应用包名下所有 Autowired类
     */
...
//    	CLASS_Autowired_SET = getClasses(packagename);
//    	System.out.println(CLASS_Autowired_SET);
//       
//        for (Class<?> cls : CLASS_Autowired_SET) {
...
//            }
//        }
//        beanClassSet.addAll(beanClassSet);
        return beanClassSet;
    }
	 /**
     * 获取应用包名下所有 Component类
     */
    public static Set<Class<?>> getComponentClassSet(String packagename) {
    	CLASS_SET = getClasses(packagename);
        Set<Class<?>> classSet = new HashSet<Class<?>>();
    ...
    /**
     * 获取应用包名下所有 Bean 类，目前支持Component
     */
